...
/* global JSClass, TKTestSuite, Deflate, DeflateStream, TKAssertNotNull, TKAssert, TKAssertEquals, TKAssertObjectEquals */
'use strict';
...
JSClass("DeflateTests", TKTestSuite, {
    ...
    testInflateLevel0: function(){
        ...
        var stream = new DeflateStream(deflated, 7, 0);
        stream.inflate();
        ...
        stream = new DeflateStream(deflated, 7, 0);
        stream.inflate();
        TKAssertEquals(stream.output.stringByDecodingUTF8(), 'this is a test');
    },
    ...
    testInflateLevel1: function(){
        ...
        var stream = new DeflateStream(deflated, 7, 2);
        stream.inflate();
        TKAssertEquals(stream.output.stringByDecodingUTF8(), 'this is a test');
    },
    ...
    testInflateLevel2: function(){
        ...
        stream = new DeflateStream(deflated, 7, 2);
        stream.inflate();
