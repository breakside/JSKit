// #import SecurityKit
// #import TestKit
/* global JSClass, JSData, TKTestSuite, TKExpectation, SECJWT */
/* global TKAssert, TKAssertEquals, TKAssertNotEquals, TKAssertFloatEquals, TKAssertExactEquals, TKAssertNotExactEquals, TKAssertObjectEquals, TKAssertObjectNotEquals, TKAssertNotNull, TKAssertNull, TKAssertUndefined, TKAssertNotUndefined, TKAssertThrows, TKAssertLessThan, TKAssertLessThanOrEquals, TKAssertGreaterThan, TKAssertGreaterThanOrEquals */
'use strict';

JSClass("SECJWTTests", TKTestSuite, {

    testValidateExampleHMACSHA256: function(){
        ...
        expectation.call(SECJWT.validateToken, SECJWT, token, keyData, function(payload){
    ...
    testValidateGoogleRSA256: function(){
        ...
        var expectation = TKExpectation.init();
        expectation.call(SECJWT.validateToken, SECJWT, token, keys, function(payload){
            TKAssertNotNull(payload);
