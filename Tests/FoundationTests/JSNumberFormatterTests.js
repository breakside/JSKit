...
JSClass("JSNumberFormatterTests", TKTestSuite, {
    ...
    testNumberFromString: function(){
        ...
        formatter.positiveSuffix = "abc";
        formatter.negativeSuffix = "abc";
        TKAssertNull(formatter.numberFromString(""));
        TKAssertNull(formatter.numberFromString("abc"));
        n = formatter.numberFromString("123");
        TKAssertExactEquals(n, 123);
        n = formatter.numberFromString("123abc");
        TKAssertExactEquals(n, 123);
        n = formatter.numberFromString("123 abc");
        TKAssertExactEquals(n, 123);
        n = formatter.numberFromString("-123");
        TKAssertExactEquals(n, -123);
        n = formatter.numberFromString("-123abc");
        ...
        n = formatter.numberFromString("-123 abc");
        TKAssertExactEquals(n, -123);
        n = formatter.numberFromString("12.3");
        TKAssertExactEquals(n, 12.3);
        n = formatter.numberFromString("12.3abc");
        TKAssertExactEquals(n, 12.3);
        n = formatter.numberFromString("12.3 abc");
        TKAssertExactEquals(n, 12.3);
        n = formatter.numberFromString("-12.3");
        TKAssertExactEquals(n, -12.3);
        n = formatter.numberFromString("-12.3abc");
        ...
        n = formatter.numberFromString("-12.3 abc");
        TKAssertExactEquals(n, -12.3);
        n = formatter.numberFromString("123a");
        TKAssertExactEquals(n, null);
        n = formatter.numberFromString("123ab");
        TKAssertExactEquals(n, null);
        n = formatter.numberFromString("123abcd");
        TKAssertExactEquals(n, null);
        n = formatter.numberFromString("123 a");
        TKAssertExactEquals(n, null);
        n = formatter.numberFromString("123 ab");
        TKAssertExactEquals(n, null);
        n = formatter.numberFromString("123 abcd");
        TKAssertExactEquals(n, null);
    }
});
