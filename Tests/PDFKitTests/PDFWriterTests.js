...
/* global JSClass, TKTestSuite, PDFWriter, PDFWriterStream, PDFWriterTestsStringStream, PDFDocumentObject, PDFPageObject, PDFPageTreeNodeObject, PDFStreamObject */
...
JSClass("PDFWriterTests", TKTestSuite, {
    ...
    testNumber: function(){
        ...
        TKAssert(isClosed);
        var expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber 0 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "56", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
        ...
        writer.close(function(){ isClosed = true; });
        TKAssert(isClosed);
        expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber 12 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "57", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
        ...
        writer.close(function(){ isClosed = true; });
        TKAssert(isClosed);
        expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber -12 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "58", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
        ...
        writer.close(function(){ isClosed = true; });
        TKAssert(isClosed);
        expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber 12.34 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "60", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
        ...
        writer.close(function(){ isClosed = true; });
        TKAssert(isClosed);
        expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber -12.34 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "61", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
        ...
        writer.close(function(){ isClosed = true; });
        TKAssert(isClosed);
        expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber 0 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "56", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
        ...
        writer.close(function(){ isClosed = true; });
        TKAssert(isClosed);
        expected = ["%PDF-1.7", "1 0 obj", "<< /XNumber 9999999999.9999999999 /Type /Catalog >>", "endobj", "xref", "0 2", "0000000000 65535 f ", "0000000009 00000 n ", "trailer", "<< /Root 1 0 R /Size 2 >>", "startxref", "76", "%%EOF"];
        TKAssertEquals(stream.string, expected.join("\n"));
