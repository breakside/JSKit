...
JSClass("UIAnimationTests", TKTestSuite, {
    ...
    testInterpolate1Color: function(){
        ...
        var color3 = UIAnimation.interpolateColor(color1, color2, 0.5);
        ...
        color3 = UIAnimation.interpolateColor(color1, color2, 0);
        TKAssertFloatEquals(color3.components[0], 0.2);
        color3 = UIAnimation.interpolateColor(color1, color2, 1);
        TKAssertFloatEquals(color3.components[0], 0.6);
        color3 = UIAnimation.interpolateColor(color1, color2, 2);
        TKAssertFloatEquals(color3.components[0], 1.0);
        color3 = UIAnimation.interpolateColor(color1, color2, -0.1);
        ...
        color3 = UIAnimation.interpolateColor(color1, color2, 0.25);
        ...
        color3 = UIAnimation.interpolateColor(color1, color2, 0.3);
    ...
    testInterpolationForValues: function(){
        ...
        TKAssertExactEquals(interpolation, UIAnimation.interpolateColor);
