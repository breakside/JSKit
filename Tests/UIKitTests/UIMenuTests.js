...
/* global JSClass, TKTestSuite, UIMenu, JSFont, JSFontDescriptor, UIMenuTestsFont, MockWindowServer, UIApplication, UIWindow, UIView, JSConstraintBox, JSRect, JSPoint */
/* global TKAssert, TKAssertEquals, TKAssertNotEquals, TKAssertFloatEquals, TKAssertExactEquals, TKAssertNotExactEquals, TKAssertObjectEquals, TKAssertObjectNotEquals, TKAssertNotNull, TKAssertNull, TKAssertUndefined, TKAssertNotUndefined, TKAssertThrows, TKAssertLessThan, TKAssertLessThanOrEquals, TKAssertGreaterThan, TKAssertGreaterThanOrEquals */
'use strict';

JSClass("UIMenuTests", TKTestSuite, {

    _createMenuWithItemCount: function(itemCount, shortestItemTitle, longestItemTitle){
        if (longestItemTitle === undefined){
            longestItemTitle = "This is an item with a really long title that gets truncated";
        }
        if (shortestItemTitle === undefined){
            shortestItemTitle = "Item";
        }
        var menu = UIMenu.init();
        menu.font = UIMenuTestsFont.init();
        menu.addItemWithTitle(shortestItemTitle);
        menu.addItemWithTitle(longestItemTitle);
        for (var i = 2; i < itemCount; ++i){
            menu.addItemWithTitle("Item");
        }
        return menu;
    },
    ...
    testOpenAdjacentToView: function(){
        ...
        // Max width
        var menu = this._createMenuWithItemCount(2);
        ...
        menu = this._createMenuWithItemCount(7, "Item 1", "Item Seven");
        ...
        menu = this._createMenuWithItemCount(24, "Item 1", "Item Seven");
        menu.openAdjacentToView(this.testView, UIMenu.Placement.below);
        TKAssertEquals(menu.window.frame.origin.x, 20);
