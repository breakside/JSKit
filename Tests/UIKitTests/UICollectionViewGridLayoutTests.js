...
JSClass("UICollectionViewGridLayoutTests", TKTestSuite, {
    ...
    testLayoutAttributesForElementsInRect: function(){
        ...
        TKAssertExactEquals(attributes[0].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        ...
        TKAssertExactEquals(attributes[1].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        ...
        TKAssertExactEquals(attributes[2].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        ...
        TKAssertExactEquals(attributes[13].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        ...
        TKAssertExactEquals(attributes[14].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        ...
        TKAssertExactEquals(attributes[15].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        ...
        TKAssertExactEquals(attributes[37].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        ...
        TKAssertExactEquals(attributes[0].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[0].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        TKAssertObjectEquals(attributes[0].indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes[0].frame, JSRect(2, 15, 307, 233));
        TKAssertExactEquals(attributes[1].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[1].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertObjectEquals(attributes[1].indexPath, JSIndexPath([0]));
        ...
        TKAssertObjectEquals(attributes[0].frame, JSRect(2, 15, 307, 233));
        TKAssertExactEquals(attributes[1].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[1].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertObjectEquals(attributes[1].indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes[1].frame, JSRect(8, 198, 293, 43));
        TKAssertExactEquals(attributes[2].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[2].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        ...
        TKAssertExactEquals(attributes[3].identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
    ...
    testLayoutAttributesForSupplimentaryViewAtIndexPath: function(){
        ...
        collectionView.bounds = JSRect(0, 0, 313, 100);
        layout.prepare();
        var attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([]), UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([]));
        TKAssertObjectEquals(attributes.frame, JSRect(2, 1, 307, 12));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([0]), UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes.frame, JSRect(2, 15, 307, 233));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([0]), UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes.frame, JSRect(8, 20, 293, 21));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([0]), UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes.frame, JSRect(8, 198, 293, 43));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([1]), UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.background);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([1]));
        TKAssertObjectEquals(attributes.frame, JSRect(2, 256, 307, 385));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([1]), UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.header);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([1]));
        TKAssertObjectEquals(attributes.frame, JSRect(8, 261, 293, 21));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([1]), UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([1]));
        TKAssertObjectEquals(attributes.frame, JSRect(8, 591, 293, 43));
        attributes = layout.layoutAttributesForSupplimentaryViewAtIndexPath(JSIndexPath([]), UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertExactEquals(attributes.elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes.identifier, UICollectionViewGridLayout.SupplimentaryIdentifier.footer);
        TKAssertObjectEquals(attributes.indexPath, JSIndexPath([]));
