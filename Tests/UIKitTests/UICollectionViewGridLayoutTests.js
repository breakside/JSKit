...
JSClass("UICollectionViewGridLayoutTests", TKTestSuite, {
    ...
    testInit: function(){
        ...
        TKAssertExactEquals(layout.headersStickToTop, false);
    },
    ...
    testInitWithSpec: function(){
        ...
        layout = UICollectionViewGridLayout.initWithSpec(spec);
        TKAssertExactEquals(layout.headersStickToTop, true);
    },
    ...
    testPrepare: function(){
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 100);
    ...
    testCollectionViewContentSize: function(){
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 1000);
        layout.prepare();
        size = layout.collectionViewContentSize;
        TKAssertFloatEquals(size.width, 313);
        TKAssertFloatEquals(size.height, 683);

        collectionView.contentView.bounds = JSRect(0, 0, 300, 1000);
        layout.prepare();
        size = layout.collectionViewContentSize;
        TKAssertFloatEquals(size.width, 300);
        TKAssertFloatEquals(size.height, 683);

        collectionView.contentView.bounds = JSRect(0, 0, 297, 1000);
        layout.prepare();
        size = layout.collectionViewContentSize;
        TKAssertFloatEquals(size.width, 297);
        TKAssertFloatEquals(size.height, 683);

        collectionView.contentView.bounds = JSRect(0, 0, 296, 1000);
        layout.prepare();
        size = layout.collectionViewContentSize;
        TKAssertFloatEquals(size.width, 296);
        TKAssertFloatEquals(size.height, 683);

        collectionView.contentView.bounds = JSRect(0, 0, 248, 1000);
        layout.prepare();
        size = layout.collectionViewContentSize;
    ...
    testLayoutAttributesForElementsInRect: function(){
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 100);
        layout.prepare();
        var attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 121);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 9);

        collectionView.contentView.bounds = JSRect(0, 0, 313, 122);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 198);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 13);

        collectionView.contentView.bounds = JSRect(0, 0, 313, 199);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 256);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 14);

        collectionView.contentView.bounds = JSRect(0, 0, 313, 257);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 261);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 15);

        collectionView.contentView.bounds = JSRect(0, 0, 313, 262);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 313, 646);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 37);

        collectionView.contentView.bounds = JSRect(0, 0, 313, 647);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 12, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 9);
        TKAssertExactEquals(attributes[0].elementCategory, UICollectionView.ElementCategory.supplimentary);
        ...
        collectionView.contentView.bounds = JSRect(0, 13, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 40, 313, 50);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 8);
        TKAssertExactEquals(attributes[0].elementCategory, UICollectionView.ElementCategory.supplimentary);
        ...
        collectionView.contentView.bounds = JSRect(0, 41, 313, 50);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 240, 313, 30);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 241, 313, 30);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        collectionView.contentView.bounds = JSRect(0, 247, 313, 30);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 3);
        TKAssertExactEquals(attributes[0].elementCategory, UICollectionView.ElementCategory.supplimentary);
        ...
        collectionView.contentView.bounds = JSRect(0, 248, 313, 30);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        ...
        layout.sectionFooterHeight = 0;
        collectionView.contentView.bounds = JSRect(0, 100, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 10);
        TKAssertExactEquals(attributes[0].elementCategory, UICollectionView.ElementCategory.cell);
        ...
        layout.collectionFooterHeight = 0;
        collectionView.contentView.bounds = JSRect(0, 424, 313, 50);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 2);
        TKAssertExactEquals(attributes[0].elementCategory, UICollectionView.ElementCategory.cell);
    ...
    testFillingCellSizeClosestToSize: function(){
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 300, 100);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 275, 100);
        ...
        collectionView.contentView.bounds = JSRect(0, 0, 274, 100);
        size = layout.fillingCellSizeClosestToSize(JSSize(100, 50));
        TKAssertExactEquals(size.width, 125);
        TKAssertExactEquals(size.height, 62);
    },

    testHeadersStickToTop: function(){
        var layout = UICollectionViewGridLayout.init();
        layout.collectionInsets = JSInsets(1, 2, 3, 4);
        layout.collectionHeaderHeight = 12;
        layout.collectionFooterHeight = 34;
        ...
        TKAssertObjectEquals(attributes[1].indexPath, JSIndexPath(0, 0));
        TKAssertObjectEquals(attributes[1].frame, JSRect(8, 45, 45, 67));
        TKAssertExactEquals(attributes[1].rowIndex, 0);
        TKAssertExactEquals(attributes[1].columnIndex, 0);
        TKAssertExactEquals(attributes[2].elementCategory, UICollectionView.ElementCategory.cell);
        TKAssertObjectEquals(attributes[2].indexPath, JSIndexPath(0, 1));
        TKAssertObjectEquals(attributes[2].frame, JSRect(56, 45, 45, 67));
        TKAssertExactEquals(attributes[2].rowIndex, 0);
        TKAssertExactEquals(attributes[2].columnIndex, 1);
        TKAssertExactEquals(attributes[3].elementCategory, UICollectionView.ElementCategory.cell);
        TKAssertObjectEquals(attributes[3].indexPath, JSIndexPath(0, 2));
        TKAssertObjectEquals(attributes[3].frame, JSRect(104, 45, 45, 67));
        TKAssertExactEquals(attributes[3].rowIndex, 0);
        TKAssertExactEquals(attributes[3].columnIndex, 2);
        TKAssertExactEquals(attributes[4].elementCategory, UICollectionView.ElementCategory.cell);
        TKAssertObjectEquals(attributes[4].indexPath, JSIndexPath(0, 3));
        TKAssertObjectEquals(attributes[4].frame, JSRect(152, 45, 45, 67));
        TKAssertExactEquals(attributes[4].rowIndex, 0);
        TKAssertExactEquals(attributes[4].columnIndex, 3);
        TKAssertExactEquals(attributes[5].elementCategory, UICollectionView.ElementCategory.cell);
        TKAssertObjectEquals(attributes[5].indexPath, JSIndexPath(0, 4));
        TKAssertObjectEquals(attributes[5].frame, JSRect(200, 45, 45, 67));
        TKAssertExactEquals(attributes[5].rowIndex, 0);
        TKAssertExactEquals(attributes[5].columnIndex, 4);
        TKAssertExactEquals(attributes[6].elementCategory, UICollectionView.ElementCategory.cell);
        TKAssertObjectEquals(attributes[6].indexPath, JSIndexPath(0, 5));
        TKAssertObjectEquals(attributes[6].frame, JSRect(248, 45, 45, 67));
        TKAssertExactEquals(attributes[6].rowIndex, 0);
        TKAssertExactEquals(attributes[6].columnIndex, 5);
        TKAssertExactEquals(attributes[7].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[7].kind, UICollectionViewGridLayout.SupplimentaryKind.header);
        TKAssertObjectEquals(attributes[7].indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes[7].frame, JSRect(8, 20, 293, 21));
        TKAssertObjectEquals(attributes[7].transform, JSAffineTransform.Identity);
        TKAssertExactEquals(attributes[8].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[8].kind, UICollectionViewGridLayout.SupplimentaryKind.header);
        TKAssertObjectEquals(attributes[8].indexPath, JSIndexPath([]));
        TKAssertObjectEquals(attributes[8].frame, JSRect(2, 1, 307, 12));
        TKAssertObjectEquals(attributes[8].transform, JSAffineTransform.Identity);

        collectionView.contentView.bounds = JSRect(0, 1, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 9);
        TKAssertExactEquals(attributes[7].elementCategory, UICollectionView.ElementCategory.supplimentary);
        ...
        collectionView.contentView.bounds = JSRect(0, 10, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 9);
        TKAssertExactEquals(attributes[7].elementCategory, UICollectionView.ElementCategory.supplimentary);
        ...
        TKAssertObjectEquals(attributes[7].indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes[7].frame, JSRect(8, 20, 293, 21));
        TKAssertObjectEquals(attributes[7].transform, JSAffineTransform.Translated(0, 2));
        TKAssertExactEquals(attributes[8].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[8].kind, UICollectionViewGridLayout.SupplimentaryKind.header);
        TKAssertObjectEquals(attributes[8].indexPath, JSIndexPath([]));
        TKAssertObjectEquals(attributes[8].frame, JSRect(2, 1, 307, 12));
        TKAssertObjectEquals(attributes[8].transform, JSAffineTransform.Translated(0, 9));

        collectionView.contentView.bounds = JSRect(0, 215, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 12);
        TKAssertExactEquals(attributes[10].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[10].kind, UICollectionViewGridLayout.SupplimentaryKind.header);
        TKAssertObjectEquals(attributes[10].indexPath, JSIndexPath([0]));
        TKAssertObjectEquals(attributes[10].frame, JSRect(8, 20, 293, 21));
        TKAssertObjectEquals(attributes[10].transform, JSAffineTransform.Translated(0, 207));
        TKAssertExactEquals(attributes[11].elementCategory, UICollectionView.ElementCategory.supplimentary);
        TKAssertExactEquals(attributes[11].kind, UICollectionViewGridLayout.SupplimentaryKind.header);
        TKAssertObjectEquals(attributes[11].indexPath, JSIndexPath([]));
        TKAssertObjectEquals(attributes[11].frame, JSRect(2, 1, 307, 12));
        TKAssertObjectEquals(attributes[11].transform, JSAffineTransform.Translated(0, 214));

        collectionView.contentView.bounds = JSRect(0, 216, 313, 100);
        layout.prepare();
        attributes = layout.layoutAttributesForElementsInRect(collectionView.contentView.bounds);
        TKAssertExactEquals(attributes.length, 12);
        TKAssertExactEquals(attributes[10].elementCategory, UICollectionView.ElementCategory.supplimentary);
        ...
        TKAssertObjectEquals(attributes[11].indexPath, JSIndexPath([]));
        TKAssertObjectEquals(attributes[11].frame, JSRect(2, 1, 307, 12));
        TKAssertObjectEquals(attributes[11].transform, JSAffineTransform.Translated(0, 215));
    }
