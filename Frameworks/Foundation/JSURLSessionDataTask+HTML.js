...
JSURLSessionDataTask.definePropertiesFromExtensions({
    ...
    _event_loadstart: function(e){
        // logger.info("%{public}, state=%d", e.type, this._xmlRequest.readyState);
    },

    _event_progress: function(e){
        // logger.info("%{public}, state=%d; %d/%d", e.type, this._xmlRequest.readyState, e.loaded, e.lengthComputable ? e.total : 0);
    ...
    _upload_event_loadstart: function(e){
        // logger.info("upload %{public}, state=%d", e.type, this._xmlRequest.readyState);
    },

    _upload_event_progress: function(e){
        // logger.info("upload %{public}, state=%d; %d/%d", e.type, this._xmlRequest.readyState), e.loaded, e.lengthComputable ? e.total : 0;
